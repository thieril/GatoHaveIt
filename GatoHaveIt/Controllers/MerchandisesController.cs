...
namespace GatoHaveIt.Controllers
{
    public class MerchandisesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemNumber,Price,Descrption,ImageURL")] Merchandise merchandise)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemNumber,Price,Descrption,ImageURL")] Merchandise merchandise)
        {
            if (ModelState.IsValid)
            {
